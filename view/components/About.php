<div class="page-banner overlay-dark bg-image" style="background-image: url(../assets/img/bg_image_1.jpg);">
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        ...
        <h1 class="font-weight-normal">Giới Thiệu </h1>
      </div> <!-- .container -->
    </div> <!-- .banner-section -->
  </div> <!-- .page-banner -->
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 wow fadeInUp">
          <h1 class="text-center mb-3">Chào mừng đến với chúng tôi</h1>
          <div class="text-lg">
        ...
        <div class="col-lg-10 mt-5">
          <h1 class="text-center mb-5 wow fadeInUp">Đội ngũ nhân viên</h1>
          <div class="row justify-content-center">
    ...
    <div class="container py-5 py-lg-0">
      <div class="row align-items-center">
        ...
        <div class="col-lg-8 wow fadeInRight">
          <h1 class="font-weight-normal mb-3" style="padding-top :20px;">Mang cả thế giới tới tay bạn</h1>
