...
<header>
      ...
      <div class="row">
        <div class="col-sm-8 text-sm">
          <div class="site-info">
            ...
            <a href="mailto:manhc3dth@gmail.com"><span class="mai-mail text-primary"></span>manhc3dth@gmail.com</a>
          </div>
        </div>
  ...
  <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
    <div class="container">
      <a class="navbar-brand" href="#"><span class="text-primary">Buy</span>& Sell</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupport">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?act=tracuu">Thống kê đơn hàng </a>
          </li>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?act=quanlyttbv">Quản lý Khách hàng</a> 
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?act=quanlyttsp">Quản lý Sản Phẩm </a> 
          </li>
          <!-- <li class="nav-item">
