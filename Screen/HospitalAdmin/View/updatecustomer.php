...
<div class="container1">
       ...
       <form class="form" method="post" > 
         ...
         <!-- <div class="form-group row">
          ...
          <div class="form-group row">
            <label for="inputname=" class="col-sm-2 col-form-label">Mã Khách Hàng</label>
            <div class="col-sm-10">
              <input type="text"  class="form-control"  name="CustomerID" value="<?php echo $id?>" readonly >
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            <label for="inputsocakhoi" class="col-sm-2 col-form-label">Ngày Sinh</label>
            <div class="col-sm-10">
              <input type="text"  class="form-control"  name="age" value="<?php echo $date?>">
            </div>
