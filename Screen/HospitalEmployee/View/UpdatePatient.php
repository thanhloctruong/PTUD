...
<div class="capnhat" style="padding: 10px;">
    ...
    <form action="" method="POST">
        <table>
            ...
            <tr>
                <td>Tên bệnh nhân:</td>
                <td><input type="text" class="form-control" name="ten" style="width:300px" value="<?php echo $HoTen?>"></td>
            </tr>
            <tr>
                <td>Ngày sinh:</td>
            ...
            <tr>
                <td>Số điện thoại:</td>
                <td><input type="text" class="form-control" name="sdt" style="width:300px" value="<?php echo $SDT?>"></td>
            </tr>
            <tr>
                <td>Email:</td>
                <td><input type="text" class="form-control"name="mail" style="width:300px" value="<?php echo $Mail?>"></td>
            </tr>
            <tr>
                <td>Số căn cước:</td>
            ...
            <tr>
                <td>Tình trạng:</td>
                <td><input type="text" class="form-control" name="tinhtrang" style="width:300px" value="<?php echo $TinhTrang?>"></td>
            </tr>
            <tr>
                <td>Kết luận:</td>
                <td><input type="text" class="form-control" name="ketluan" style="width:300px" value="<?php echo $KetLuan?>"></td>
            </tr>
        </table>
</br>
