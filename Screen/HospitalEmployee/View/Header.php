    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupport">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?act=addbaogia">Tạo báo giá</a> <!--Counseling-->
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?act=tracuu">Xem thống kê đơn hàng mua</a> <!--ManagePatientInformation--> 
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?act=quanly">Quản lý nhà cung cấp</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?act=taodon">Tạo đơn mua hàng</a>
          </li>
