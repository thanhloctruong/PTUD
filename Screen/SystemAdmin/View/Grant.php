  ...
  <center>
    ...
    <form action="" method="POST" style="padding: 50px 0px ;" >
        <table>
            <tr>
                <td>Mã Tài Khoản:</td>
                <td><input type="text" class="form-control" name="UserID" style="width:300px" value="<?php echo $UserID?>" readonly></td>
            </tr>
            <tr>
                <td>HọTên:</td>
                <td><input type="text" class="form-control" name="HoTen" style="width:300px" value="<?php echo $HoTen?>" readonly></td>
            </tr>
        ...
        <input type="submit" value="Cập nhật"  name="btn" class="btn btn-primary" style="margin:20px 0px ;">
    </form>
