...
<div class="capnhat" style="padding: 10px;">
    ...
    <form action="" method="POST" >
        <table>
            ...
            <tr>
                <td>Mật Khẩu:</td>
                <td><input type="text" class="form-control" name="pass" style="width:300px" value="<?php echo $pass?>"></td>
            </tr>
            <tr>
                <td>Họ Tên:</td>
            ...
            <tr>
                <td>Phường Công Tác:</td>
                <td><input type="text" class="form-control" name="phuong" style="width:300px" value="<?php echo $phuongct?>"></td>
            </tr>
        </table>
