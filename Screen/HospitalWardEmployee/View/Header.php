      ...
      <div class="row">
        <div class="col-sm-8 text-sm">
          <div class="site-info">
            ...
            <a href="mailto:nhom6868@gmail.com"><span class="mai-mail text-primary"></span>nhom32@gmail.com</a>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupport">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?act=thongke">Thống kê đơn hàng bán</a> <!--Counseling-->
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?act=quanly">Quản lý thông tin đơn hàng
